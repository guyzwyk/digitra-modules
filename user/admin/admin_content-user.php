<?php 
	require("../modules/user/langfiles/".$langFile.".php"); //Module language pack
	require('../modules/user/inc/user_validations.php');
	//Initializations
    $user	        =   new cwd_user();
	    ...
	    <h3><?php print $mod_lang_output['MODULE_NAME']; ?> :: <?php print $mod_lang_output['PAGE_HEADER_ADD_USER']; ?></h3>
	      ...
	      ****************************************************************************************************************-->
	      ...
	      <?php if(!isset($_REQUEST[what]) || ($_REQUEST[what]=="display")) { ?>
			<h3>
			<?php print $mod_lang_output['MODULE_NAME']; ?> :: <?php print $mod_lang_output['PAGE_HEADER_LIST_USERS']; ?>
				<span class="float-right">
					<a title="<?php print $mod_lang_output['FORM_BUTTON_ADD_USER']; ?>" href="?page=user&what=insert"><?php print $system->admin_button_crud('create'); ?></a>
				</span>
			</h3>
	      ...
	      ****************************************************************************************************************-->
	      <?php 
	      	if($_REQUEST[what] == "update") { // Si on a clique sur modifier l'annuaire... 
