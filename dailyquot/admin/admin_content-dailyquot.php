<?php 
    require("../modules/dailyquot/langfiles/".$langFile.".php"); //Module language pack
    require_once('../modules/dailyquot/inc/dailyquot_validations.php');
?>
<?php if($_REQUEST['what'] != 'display'){ ?>
	<h3>
		<span class="float-right">
			<a href="admin.php?page=<?php print $dailyquot->modName; ?>&what=display" title="<?php print $mod_lang_output['PAGE_HEADER_LIST_DAILYQUOT']; ?>"><?php print $system->admin_button_crud('back'); ?></a>
		</span>
	</h3>
<?php } ?>
...
<!-- ********************************* Inserer les categories de dailyquots  ******************************************************
    ...
    ****************************************************************************************************************-->
	...
	<div class="clearfix"></div>
			...
			<div class="form-group">
	            ...
	            <div class="col-sm-8">
	              	<select class="form-control"  name="dailyquot_selLang" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
	      				<?php print stripslashes($dailyquot->redir_cmb_load_langs($_REQUEST['langId'], $dailyquot->admin_modPage, "insert")); ?>
	      		  	</select>
          	...
          	<div class="form-group">
	            ...
	            <div class="col-sm-8">
	            	<?php print $dailyquot->combo_date($_POST['cmbDay'], $_POST['cmbMonth'], $_POST['cmbYear'], '', $currentLang); ?>
	            </div>
	            <div class="col-sm-2">&nbsp;</div>
          	</div>
      ...
      ****************************************************************************************************************-->
      <?php 
      	if($_REQUEST[what] == "update") { // Si on a clique sur modifier le dailyquot... 
