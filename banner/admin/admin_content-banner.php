...
*************************************************************************************************** -->
      <?php if($_REQUEST['what'] == 'update') { $tabBanner = $myBanner->get_banner($_REQUEST[$myBanner->URI_bannerVar]); ?>
		...
		<?php } ?>
			...
			<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
          		...
          		<div class="panel-body no-padding">
          				<span style="float:right;"><a title="<?php print $mod_lang_output['FORM_BUTTON_ADD_BANNER']; ?>" href="?page=banner&what=insert"><?php print $system->admin_button('insert'); ?></a></span>
