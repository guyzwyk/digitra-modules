...
?>
     ...
     ****************************************************************************************************************-->
    <?php if(isset($news_catUpdate) && ($_REQUEST[what]=="catDisplay")){ ?>
    <div class="col-sm-6">
               ...
               <div class="form-group">
                   ...
                   <div class="col-sm-8">
                       <select class="form-control" name="sel_newsCat" id="sel_newsCat">
                           <?php print $news->admin_cmb_show_rub_by_lang($_SESSION['LANG'], $_POST[sel_newsCat]); ?>
                       </select>
                   </div>
                   <div class="col-sm-2">
                       <!-- <p class="help-block">04 Caracters Max</p> -->
  ...
  <!-- ********************************* Afficher les auteurs de news  ******************************************************
     ****************************************************************************************************************-->
     <div class="col-sm-6">
         <?php if($_REQUEST[what]== "_authorDisplay") { ?>
   ...
   <!-- ********************************* Insert news author groups ******************************************************
     ****************************************************************************************************************-->
     <?php if($_REQUEST[what]== "_authorGroupInsert") { ?>
    ...
    <!-- ********************************* Create news authors ******************************************************
     ****************************************************************************************************************-->       
       <?php if($_REQUEST['what'] ==  '_authorInsert'){ ?>
   ...
   <!-- ********************************* Display news author groups ******************************************************
     ****************************************************************************************************************-->
     <div class="col-sm-6">
       <?php if($_REQUEST[what]=="_authorCatDisplay") { ?>
   ...
   <!-- ********************************* Update news author groups ******************************************************
     ****************************************************************************************************************-->
    <div class="col-sm-6">
       <?php if(($_REQUEST[what]=="_authorCatDisplay") && (isset($news_authorCatUpdate))) { ?>
...
<!-- ********************************* Display news comments ******************************************************
     ****************************************************************************************************************-->
    <?php if($_REQUEST[what]=="_commentDisplay") { ?>
