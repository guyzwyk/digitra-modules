...
?>
	<h3>
		<span class="float-right">
			<?php if($_REQUEST['what'] != 'display'){ ?>
				<a href="admin.php?page=<?php print $annonce->modName; ?>&what=display" title="<?php print $mod_lang_output['PAGE_HEADER_LIST_ANNONCE']; ?>"><?php print $system->admin_button_crud('back'); ?></a>
			<?php } ?>
		</span>
	</h3>
	...
	****************************************************************************************************************-->
	...
	<?php if(!isset($_REQUEST['what']) || ($_REQUEST['what']=="display")) { ?>
		<h3>
		  	<?php print $mod_lang_output['MODULE_NAME']; ?> :: <?php print $mod_lang_output['PAGE_HEADER_LIST_ANNONCE']; ?>
			<span class="float-right">
			<a title="<?php print $mod_lang_output['FORM_BUTTON_ADD_ANNONCE']; ?>" data-toggle="modal" data-target="#modal-annonceInsert"><?php print $system->admin_button_crud('create'); ?></a>
				<!-- <a title="<?php print $mod_lang_output['FORM_BUTTON_ADD_ANNONCE']; ?>" href="?page=annonce&what=insert"><?php print $system->admin_button_crud('create'); ?></a> -->
				<a title="<?php print $mod_lang_output['FORM_BUTTON_LIST_ANNONCES']; ?>" data-toggle="modal" data-target="#modal-annonceDisplay"><?php print $system->admin_button_crud('read'); ?></a>
			</span>
		</h3>
		...
		<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
			<div class="panel-body no-padding">
			    <?php print $annonce->admin_load_annonces(50, $_POST['limite']); ?>
			</div>
		</div>
	<?php } ?>
	...
	****************************************************************************************************************-->
	...
	<?php if($_REQUEST['what']=="catInsert"){ ?>
		...
		<h3>
			<?php print $mod_lang_output['MODULE_NAME']; ?> :: <?php print $mod_lang_output['PAGE_HEADER_ADD_ANNONCE_CATEGORY']; ?>
		</h3>
	...
	****************************************************************************************************************-->
		...
		*****************************************************************************************************************************-->
		...
		<div class="col-sm-6">
			...
			<?php if(($_REQUEST['what']=="catDisplay") && (isset($rub_displayUpd))){ ?>
							...
							<div class="panel-footer">
			                    <div class="row">
			                        <div class="col-sm-8 col-sm-offset-2">
			                            ...
			                            <input type="hidden" name="hd_cat_id" value="<?php print $_REQUEST['acId']; ?>" />
			                        </div>
			                    </div>
			                </div>
		...
		<div class="clearfix"></div>
			    ...
			    <h3><?php print $mod_lang_output['MODULE_NAME']; ?> :: <?php print $mod_lang_output['PAGE_HEADER_ADD_ANNONCE']; ?></h3>
						        ...
						        <div class="form-group">
						          	...
						          	<div class="col-sm-8">
						              	<select class="form-control"  name="annonce_selLang" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
						      				<?php print stripslashes($annonce->redir_cmb_load_langs($_REQUEST[langId], $annonce->admin_modPage, "insert")); ?>
						      		  	</select>
						      		  	<input name="hdLang" type="hidden" value="<?php  print (!isset($_REQUEST['langId']) ? ($settings['LANG']) : ($_REQUEST['langId'])); ?>" />
									</div>
									<div class="col-sm-2">
		                                <!-- <p class="help-block">Your help text!</p> -->
		                            </div>
			      ...
			      ****************************************************************************************************************-->
			      <?php 
			      	if($_REQUEST['what'] == "update") { // Si on a clique sur modifier l'annonce... 
