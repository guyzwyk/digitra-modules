<?php 
	require("../modules/file/langfiles/".$langFile.".php"); //Module language pack
...
<!-- ********************************* Ajouter les categories de fichiers  ***************************************
              	...
              	<div class="form-group">
					...
					<div class="col-sm-8">
                        <select class="form-control"  name="file_selLang" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
                          ...
                          <input name="file_hdLang" type="hidden" value="<?php  print $selected_lang = (!isset($_REQUEST['langId']) ? ($settings['LANG']) : ($_REQUEST['langId'])); ?>" />
					</div>
					<div class="col-sm-2">
						<!-- <p class="help-block">Your help text!</p> -->
					</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-8">
                        <select name="file_selCat" id="file_selCat" class="form-control">
                        	<?php print $file->admin_cmb_show_rub_by_lang($file->tbl_fileCat, $file->fld_fileCatLib, $selected_lang, $_POST['file_selCat']); ?>
                        </select>
					</div>
					<div class="col-sm-2">
						<!-- <p class="help-block">Your help text!</p> -->
      ...
      ****************************************************************************************************************--> 
      <?php 
      	if($_REQUEST[what] == "update") { // Si on a clique sur modifier le fichier... 
